...
function getWorkload(active: number): { label: string; color: string; bg: string; bar: string } {
  if (active === 0) return { label: "Libre",         color: "#3ecf8e", bg: "bg-[#3ecf8e]/10", bar: "#3ecf8e" };
  if (active <= 3)  return { label: "Normal",        color: "#4f7cff", bg: "bg-[#4f7cff]/10", bar: "#4f7cff" };
  if (active <= 6)  return { label: "Cargado",       color: "#f5a623", bg: "bg-[#f5a623]/10", bar: "#f5a623" };
